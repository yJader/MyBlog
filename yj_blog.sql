/*
 ...
 Source Schema         : yj_blog

 Target Server Type    : MySQL
 Target Server Version : 80030
 File Encoding         : 65001

 Date: 18/03/2023 20:58:23
*/
...
INSERT INTO `sys_menu` VALUES (2034, '111', 2017, 1, '落落', NULL, 1, 'M', '0', '0', NULL, 'build', 1, '2023-03-13 00:38:29', NULL, '2023-03-13 19:33:35', '', '1');
...
CREATE TABLE `sys_role`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '角色信息表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_role` VALUES (13, 'testtest', 'test111', 100, '0', '0', 1, '2023-03-14 12:50:55', NULL, '2023-03-14 21:26:30', '测试用');
INSERT INTO `sys_role` VALUES (14, 'test2', 'test2', 100, '0', '1', 1, '2023-03-14 23:14:38', NULL, '2023-03-15 16:37:35', 'test2');
INSERT INTO `sys_role` VALUES (15, 'test3', 'test3', 100, '0', '0', 1, '2023-03-14 23:20:31', 1, '2023-03-14 23:20:31', 'test3');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'yj1', 'yjzzz', '$2a$10$Jnq31rRkNV3RNzXe0REsEOSKaYK8UgVZZqlNlNXqn.JeVcj2NdeZy', '1', '0', '23412332@qq.com', '18888888888', '0', 'http://rq4moiqhu.hn-bkt.clouddn.com/2023/02/28/ca2c50338ffc4cd0ab574dc251e6f4d0.jpg', NULL, '2022-01-05 09:01:56', 1, '2022-01-30 15:37:03', 0);
INSERT INTO `sys_user` VALUES (2, 'yj2', 'weqe', '$2a$10$Jnq31rRkNV3RNzXe0REsEOSKaYK8UgVZZqlNlNXqn.JeVcj2NdeZy', '1', '0', NULL, NULL, '0', NULL, NULL, '2022-01-05 13:28:43', NULL, '2022-01-05 13:28:43', 0);
INSERT INTO `sys_user` VALUES (4, 'yj4', 'dsadd', '$2a$10$kY4T3SN7i4muBccZppd2OOkhxMN6yt8tND1sF89hXOaFylhY2T3he', '1', '0', '23412332@qq.com', '19098790742', '0', NULL, NULL, NULL, NULL, NULL, 0);
INSERT INTO `sys_user` VALUES (5, 'yj2233', 'tteqe', '', '1', '0', NULL, '18246845873', '1', NULL, NULL, '2022-01-06 03:51:13', NULL, '2022-01-06 07:00:50', 0);
...
INSERT INTO `sys_user` VALUES (14787164048663, 'yj111', 'yj111_nick', '$2a$10$5Cyl/ewlemgaAVHkIBVtoO7YTQtagAorSNBbJn0Pahqn.G2D1ZtwO', '0', '0', '123@yj.com', NULL, '0', 'http://rq4moiqhu.hn-bkt.clouddn.com/2023/02/16/ee6d57c63866482aac1409dc18906043.jpg', NULL, NULL, NULL, '2023-03-15 23:52:12', 0);
INSERT INTO `sys_user` VALUES (14787164048664, 'test6', 'test6', '$2a$10$JRU4sGiTW5YdDp.h6kErwe209SsMAg0pG2Km7bF5SMKa6c7lRKiNi', '0', '0', '12345@fzu.edu.cn', '19906911930', '1', NULL, 1, '2023-03-15 20:40:58', NULL, '2023-03-15 23:52:02', 0);
...
INSERT INTO `sys_user_role` VALUES (14787164048663, 15);
INSERT INTO `sys_user_role` VALUES (14787164048664, 13);
INSERT INTO `sys_user_role` VALUES (14787164048664, 15);

-- ----------------------------
-- Table structure for yj_article
-- ----------------------------
DROP TABLE IF EXISTS `yj_article`;
...
-- ----------------------------
-- Records of yj_article
-- ----------------------------
INSERT INTO `yj_article` VALUES (1, 'SpringSecurity从入门到精通', '## 课程介绍\n![image20211219121555979.png](https://sg-blog-oss.oss-cn-beijing.aliyuncs.com/2022/01/31/e7131718e9e64faeaf3fe16404186eb4.png)\n\n## 0. 简介1\n\n​	**Spring Security** 是 Spring 家族中的一个安全管理框架。相比与另外一个安全框架**Shiro**，它提供了更丰富的功能，社区资源也比Shiro丰富。\n\n​	一般来说中大型的项目都是使用**SpringSecurity** 来做安全框架。小项目有Shiro的比较多，因为相比与SpringSecurity，Shiro的上手更加的简单。\n\n​	 一般Web应用的需要进行**认证**和**授权**。\n\n​		**认证：验证当前访问系统的是不是本系统的用户，并且要确认具体是哪个用户**\n\n​		**授权：经过认证后判断当前用户是否有权限进行某个操作**\n\n​	而认证和授权也是SpringSecurity作为安全框架的核心功能。\n\n\n\n## 1. 快速入门\n\n### 1.1 准备工作\n\n​	我们先要搭建一个简单的SpringBoot工程\n\n① 设置父工程 添加依赖\n\n~~~~\n    <parent>\n        <groupId>org.springframework.boot</groupId>\n        <artifactId>spring-boot-starter-parent</artifactId>\n        <version>2.5.0</version>\n    </parent>\n    <dependencies>\n        <dependency>\n            <groupId>org.springframework.boot</groupId>\n            <artifactId>spring-boot-starter-web</artifactId>\n        </dependency>\n        <dependency>\n            <groupId>org.projectlombok</groupId>\n            <artifactId>lombok</artifactId>\n            <optional>true</optional>\n        </dependency>\n    </dependencies>\n~~~~\n\n② 创建启动类\n\n~~~~\n@SpringBootApplication\npublic class SecurityApplication {\n\n    public static void main(String[] args) {\n        SpringApplication.run(SecurityApplication.class,args);\n    }\n}\n\n~~~~\n\n③ 创建Controller\n\n~~~~java\n\nimport org.springframework.web.bind.annotation.RequestMapping;\nimport org.springframework.web.bind.annotation.RestController;\n\n@RestController\npublic class HelloController {\n\n    @RequestMapping(\"/hello\")\n    public String hello(){\n        return \"hello\";\n    }\n}\n\n~~~~\n\n\n\n### 1.2 引入SpringSecurity\n\n​	在SpringBoot项目中使用SpringSecurity我们只需要引入依赖即可实现入门案例。\n\n~~~~xml\n        <dependency>\n            <groupId>org.springframework.boot</groupId>\n            <artifactId>spring-boot-starter-security</artifactId>\n        </dependency>\n~~~~\n\n​	引入依赖后我们在尝试去访问之前的接口就会自动跳转到一个SpringSecurity的默认登陆页面，默认用户名是user,密码会输出在控制台。\n\n​	必须登陆之后才能对接口进行访问。\n\n\n\n## 2. 认证\n\n### 2.1 登陆校验流程\n![image20211215094003288.png](https://sg-blog-oss.oss-cn-beijing.aliyuncs.com/2022/01/31/414a87eeed344828b5b00ffa80178958.png)\n\n## 3. 测试', 'SpringSecurity框架教程-Spring Security+JWT实现项目级前端分离认证授权', 1, 'https://sg-blog-oss.oss-cn-beijing.aliyuncs.com/2022/01/31/948597e164614902ab1662ba8452e106.png', '1', '0', 250, '0', NULL, '2022-01-23 23:20:11', NULL, '2023-03-11 21:16:39', 0);
INSERT INTO `yj_article` VALUES (2, 'weq', 'adadaeqe', 'adad', 2, 'https://sg-blog-oss.oss-cn-beijing.aliyuncs.com/2022/01/15/fd2e9460c58a4af3bbeae5d9ed581688.png', '1', '0', 22, '0', NULL, '2022-01-21 14:58:30', NULL, NULL, 1);
INSERT INTO `yj_article` VALUES (3, 'dad', 'asdasda', 'sadad', 1, 'https://sg-blog-oss.oss-cn-beijing.aliyuncs.com/2022/01/15/737a0ed0b8ea430d8700a12e76aa1cd1.png', '1', '0', 33, '0', NULL, '2022-01-18 14:58:34', NULL, NULL, 1);
INSERT INTO `yj_article` VALUES (5, '', '', 'adsd', 2, '', '', '', 44, '', NULL, '2022-01-17 14:58:37', NULL, '2023-03-11 21:02:28', 0);
INSERT INTO `yj_article` VALUES (8, '测试测试', '# 测试\n1. this is\n2. test', '这是一个测试XD', 1, 'http://rq4moiqhu.hn-bkt.clouddn.com/2023/03/06/6bb03842889449d58822aea78ab7fb5a.jpg', '1', '0', 0, '0', 1, '2023-03-06 23:53:38', 1, '2023-03-06 23:53:38', 0);
INSERT INTO `yj_article` VALUES (9, 'testtest', '# Test', '1111', 2, '', '1', '0', 0, '0', 1, '2023-03-13 00:32:44', NULL, '2023-03-13 00:32:48', 1);

-- ----------------------------
-- Table structure for yj_article_tag
-- ----------------------------
DROP TABLE IF EXISTS `yj_article_tag`;
CREATE TABLE `yj_article_tag`  (
...
-- ----------------------------
-- Records of yj_article_tag
-- ----------------------------
INSERT INTO `yj_article_tag` VALUES (1, 4);
INSERT INTO `yj_article_tag` VALUES (2, 1);
INSERT INTO `yj_article_tag` VALUES (2, 4);
INSERT INTO `yj_article_tag` VALUES (3, 4);
INSERT INTO `yj_article_tag` VALUES (3, 5);
INSERT INTO `yj_article_tag` VALUES (8, 1);
INSERT INTO `yj_article_tag` VALUES (8, 4);
INSERT INTO `yj_article_tag` VALUES (8, 6);
INSERT INTO `yj_article_tag` VALUES (9, 6);

-- ----------------------------
-- Table structure for yj_category
-- ----------------------------
DROP TABLE IF EXISTS `yj_category`;
CREATE TABLE `yj_category`  (
  ...
  `del_flag` int NULL DEFAULT 0 COMMENT '删除标志（0代表未删除，1代表已删除）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 251 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '分类表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of yj_category
-- ----------------------------
INSERT INTO `yj_category` VALUES (1, 'java', -1, 'wsd', '0', NULL, NULL, NULL, NULL, 0);
INSERT INTO `yj_category` VALUES (2, 'PHP', -1, 'wsd', '0', NULL, NULL, NULL, NULL, 0);
INSERT INTO `yj_category` VALUES (250, 'springboot', -1, 'Spring Boot是由Pivotal团队提供的一套开源框架，可以简化spring应用的创建及部署', '0', NULL, NULL, NULL, '2023-03-16 00:15:11', 0);
INSERT INTO `yj_category` VALUES (251, 'test', -1, 'test', '0', 1, '2023-03-16 00:15:20', 1, '2023-03-16 00:15:20', 0);

-- ----------------------------
-- Table structure for yj_comment
-- ----------------------------
DROP TABLE IF EXISTS `yj_comment`;
...
-- ----------------------------
-- Records of yj_comment
-- ----------------------------
INSERT INTO `yj_comment` VALUES (1, '0', 1, -1, 'asS', -1, -1, 1, '2022-01-29 07:59:22', 1, '2022-01-29 07:59:22', 0);
INSERT INTO `yj_comment` VALUES (2, '0', 1, -1, '[哈哈]SDAS', -1, -1, 1, '2022-01-29 08:01:24', 1, '2022-01-29 08:01:24', 0);
INSERT INTO `yj_comment` VALUES (3, '0', 1, -1, '是大多数', -1, -1, 1, '2022-01-29 16:07:24', 1, '2022-01-29 16:07:24', 0);
INSERT INTO `yj_comment` VALUES (4, '0', 1, -1, '撒大声地', -1, -1, 1, '2022-01-29 16:12:09', 1, '2022-01-29 16:12:09', 0);
INSERT INTO `yj_comment` VALUES (5, '0', 1, -1, '你再说什么', -1, -1, 1, '2022-01-29 18:19:56', 1, '2022-01-29 18:19:56', 0);
INSERT INTO `yj_comment` VALUES (6, '0', 1, -1, 'hffd', -1, -1, 1, '2022-01-29 22:13:52', 1, '2022-01-29 22:13:52', 0);
INSERT INTO `yj_comment` VALUES (9, '0', 1, 2, '你说什么', 1, 2, 1, '2022-01-29 22:18:40', 1, '2022-01-29 22:18:40', 0);
INSERT INTO `yj_comment` VALUES (10, '0', 1, 2, '哈哈哈哈[哈哈]', 1, 9, 1, '2022-01-29 22:29:15', 1, '2022-01-29 22:29:15', 0);
INSERT INTO `yj_comment` VALUES (11, '0', 1, 2, 'we全文', 1, 10, 3, '2022-01-29 22:29:55', 1, '2022-01-29 22:29:55', 0);
INSERT INTO `yj_comment` VALUES (12, '0', 1, -1, '王企鹅', -1, -1, 1, '2022-01-29 22:30:20', 1, '2022-01-29 22:30:20', 0);
INSERT INTO `yj_comment` VALUES (13, '0', 1, -1, '什么阿是', -1, -1, 1, '2022-01-29 22:30:56', 1, '2022-01-29 22:30:56', 0);
INSERT INTO `yj_comment` VALUES (14, '0', 1, -1, '新平顶山', -1, -1, 1, '2022-01-29 22:32:51', 1, '2022-01-29 22:32:51', 0);
INSERT INTO `yj_comment` VALUES (15, '0', 1, -1, '2222', -1, -1, 1, '2022-01-29 22:34:38', 1, '2022-01-29 22:34:38', 0);
INSERT INTO `yj_comment` VALUES (16, '0', 1, 2, '3333', 1, 11, 1, '2022-01-29 22:34:47', 1, '2022-01-29 22:34:47', 0);
INSERT INTO `yj_comment` VALUES (17, '0', 1, 2, '回复weqedadsd', 3, 11, 1, '2022-01-29 22:38:00', 1, '2022-01-29 22:38:00', 0);
INSERT INTO `yj_comment` VALUES (18, '0', 1, -1, 'sdasd', -1, -1, 1, '2022-01-29 23:18:19', 1, '2022-01-29 23:18:19', 0);
INSERT INTO `yj_comment` VALUES (19, '0', 1, -1, '111', -1, -1, 1, '2022-01-29 23:22:23', 1, '2022-01-29 23:22:23', 0);
INSERT INTO `yj_comment` VALUES (20, '0', 1, 1, '你说啥？', 1, 1, 1, '2022-01-30 10:06:21', 1, '2022-01-30 10:06:21', 0);
INSERT INTO `yj_comment` VALUES (21, '0', 1, -1, '友链添加个呗', -1, -1, 1, '2022-01-30 10:06:50', 1, '2022-01-30 10:06:50', 0);
INSERT INTO `yj_comment` VALUES (22, '1', 1, -1, '友链评论2', -1, -1, 1, '2022-01-30 10:08:28', 1, '2022-01-30 10:08:28', 0);
INSERT INTO `yj_comment` VALUES (23, '1', 1, 22, '回复友链评论3', 1, 22, 1, '2022-01-30 10:08:50', 1, '2022-01-30 10:08:50', 0);
INSERT INTO `yj_comment` VALUES (24, '1', 1, -1, '友链评论4444', -1, -1, 1, '2022-01-30 10:09:03', 1, '2022-01-30 10:09:03', 0);
INSERT INTO `yj_comment` VALUES (25, '1', 1, 22, '收到的', 1, 22, 1, '2022-01-30 10:13:28', 1, '2022-01-30 10:13:28', 0);
INSERT INTO `yj_comment` VALUES (26, '0', 1, -1, 'sda', -1, -1, 1, '2022-01-30 10:39:05', 1, '2022-01-30 10:39:05', 0);
INSERT INTO `yj_comment` VALUES (27, '0', 1, 1, '说你咋地', 1, 20, 14787164048662, '2022-01-30 17:19:30', 14787164048662, '2022-01-30 17:19:30', 0);
INSERT INTO `yj_comment` VALUES (28, '0', 1, 1, 'sdad', 1, 1, 14787164048662, '2022-01-31 11:11:20', 14787164048662, '2022-01-31 11:11:20', 0);
INSERT INTO `yj_comment` VALUES (29, '0', 1, -1, '你说是的ad', -1, -1, 14787164048662, '2022-01-31 14:10:11', 14787164048662, '2022-01-31 14:10:11', 0);
INSERT INTO `yj_comment` VALUES (30, '0', 1, 1, '撒大声地', 1, 1, 14787164048662, '2022-01-31 20:19:18', 14787164048662, '2022-01-31 20:19:18', 0);
INSERT INTO `yj_comment` VALUES (31, '0', 1, 1, '[嘻嘻]\n', 1, 1, 1, '2023-02-15 20:04:44', 1, '2023-02-15 20:04:44', 0);
INSERT INTO `yj_comment` VALUES (32, '1', 1, -1, '很好的链接 英雄联盟 爱来自瓷器[可爱]', -1, -1, 1, '2023-02-15 21:03:00', 1, '2023-02-15 21:03:00', 0);
INSERT INTO `yj_comment` VALUES (33, '0', 1, -1, '啊对对对', -1, -1, 1, '2023-02-16 11:21:26', 1, '2023-02-16 11:21:26', 0);

-- ----------------------------
-- Table structure for yj_link
-- ----------------------------
DROP TABLE IF EXISTS `yj_link`;
CREATE TABLE `yj_link`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
...
-- Records of yj_tag
-- ----------------------------
INSERT INTO `yj_tag` VALUES (1, 'Mybatis', NULL, NULL, NULL, '2022-01-11 09:20:50', 0, 'weqwe');
INSERT INTO `yj_tag` VALUES (2, 'asdas', NULL, '2022-01-11 09:20:55', NULL, '2022-01-11 09:20:55', 1, 'weqw');
INSERT INTO `yj_tag` VALUES (3, 'weqw', NULL, '2022-01-11 09:21:07', NULL, '2022-01-11 09:21:07', 1, 'qweqwe');
INSERT INTO `yj_tag` VALUES (4, 'Java', NULL, '2022-01-13 15:22:43', NULL, '2022-01-13 15:22:43', 0, 'sdad');
INSERT INTO `yj_tag` VALUES (5, 'WAD', NULL, '2022-01-13 15:22:47', NULL, '2022-01-13 15:22:47', 0, 'ASDAD');
INSERT INTO `yj_tag` VALUES (6, 'test', NULL, NULL, NULL, NULL, 0, '测试测试');
